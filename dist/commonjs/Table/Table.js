...
var Table = function (_Component) {
  ...
  Table.prototype.forceUpdateGrid = function forceUpdateGrid() {
  ...
  Table.prototype.measureAllRows = function measureAllRows() {
  ...
  Table.prototype.recomputeRowHeights = function recomputeRowHeights() {
  ...
  Table.prototype.scrollToRow = function scrollToRow() {
    var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  ...
  Table.prototype._createColumn = function _createColumn(_ref) {
  ...
  Table.prototype._createHeader = function _createHeader(_ref2) {
  ...
  Table.prototype._createRow = function _createRow(_ref3) {
    var _this3 = this;
  ...
  Table.prototype._getFlexStyleForColumn = function _getFlexStyleForColumn(column) {
  ...
  Table.prototype._getRenderedHeaderRow = function _getRenderedHeaderRow() {
    var _this4 = this;
  ...
  Table.prototype._getRowHeight = function _getRowHeight(rowIndex) {
  ...
  Table.prototype._onScroll = function _onScroll(_ref4) {
  ...
  Table.prototype._onSectionRendered = function _onSectionRendered(_ref5) {
  ...
  Table.prototype._setRef = function _setRef(ref) {
    this.Grid = ref;
  };

  Table.prototype._setScrollbarWidth = function _setScrollbarWidth() {
