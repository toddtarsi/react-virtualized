...
var Grid = function (_Component) {
  ...
  Grid.prototype.measureAllCells = function measureAllCells() {
  ...
  Grid.prototype.recomputeGridSize = function recomputeGridSize() {
  ...
  Grid.prototype.scrollToCell = function scrollToCell(_ref2) {
  ...
  Grid.prototype.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {
    var _this2 = this;
  ...
  Grid.prototype.componentWillUpdate = function componentWillUpdate(nextProps, nextState) {
    var _this3 = this;
  ...
  Grid.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    return (0, _reactAddonsShallowCompare2.default)(this, nextProps, nextState);
  };

  /* ---------------------------- Helper methods ---------------------------- */

  Grid.prototype._calculateChildrenToRender = function _calculateChildrenToRender() {
  ...
  Grid.prototype._debounceScrollEnded = function _debounceScrollEnded() {
  ...
  Grid.prototype._debounceScrollEndedCallback = function _debounceScrollEndedCallback() {
  ...
  Grid.prototype._getEstimatedColumnSize = function _getEstimatedColumnSize(props) {
    return typeof props.columnWidth === 'number' ? props.columnWidth : props.estimatedColumnSize;
  };

  Grid.prototype._getEstimatedRowSize = function _getEstimatedRowSize(props) {
    return typeof props.rowHeight === 'number' ? props.rowHeight : props.estimatedRowSize;
  };

  Grid.prototype._invokeOnGridRenderedHelper = function _invokeOnGridRenderedHelper() {
  ...
  Grid.prototype._invokeOnScrollMemoizer = function _invokeOnScrollMemoizer(_ref3) {
    var _this4 = this;
  ...
  Grid.prototype._setScrollingContainerRef = function _setScrollingContainerRef(ref) {
    this._scrollingContainer = ref;
  };

  Grid.prototype._setScrollPosition = function _setScrollPosition(_ref5) {
  ...
  Grid.prototype._wrapPropertyGetter = function _wrapPropertyGetter(value) {
    return value instanceof Function ? value : function () {
      return value;
    };
  };

  Grid.prototype._wrapSizeGetter = function _wrapSizeGetter(size) {
    return this._wrapPropertyGetter(size);
  };

  Grid.prototype._updateScrollLeftForScrollToColumn = function _updateScrollLeftForScrollToColumn() {
    var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.props;
    var state = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.state;
  ...
  Grid.prototype._updateScrollTopForScrollToRow = function _updateScrollTopForScrollToRow() {
    var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.props;
    var state = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.state;
  ...
  Grid.prototype._onScroll = function _onScroll(event) {
