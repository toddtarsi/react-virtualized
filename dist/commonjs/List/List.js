...
var List = function (_Component) {
  ...
  List.prototype.forceUpdateGrid = function forceUpdateGrid() {
  ...
  List.prototype.measureAllRows = function measureAllRows() {
  ...
  List.prototype.recomputeRowHeights = function recomputeRowHeights() {
  ...
  List.prototype.scrollToRow = function scrollToRow() {
    var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  ...
  List.prototype._cellRenderer = function _cellRenderer(_ref) {
  ...
  List.prototype._setRef = function _setRef(ref) {
    this.Grid = ref;
  };

  List.prototype._onScroll = function _onScroll(_ref2) {
  ...
  List.prototype._onSectionRendered = function _onSectionRendered(_ref3) {
