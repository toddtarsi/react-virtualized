...
var CellMeasurer = function (_Component) {
  ...
  function CellMeasurer(props, state) {
    ...
    var _this = _possibleConstructorReturn(this, _Component.call(this, props, state));
  ...
  CellMeasurer.prototype.getColumnWidth = function getColumnWidth(_ref) {
  ...
  CellMeasurer.prototype.getRowHeight = function getRowHeight(_ref2) {
  ...
  CellMeasurer.prototype.resetMeasurementForColumn = function resetMeasurementForColumn(columnIndex) {
    this._cellSizeCache.clearColumnWidth(columnIndex);
  };

  CellMeasurer.prototype.resetMeasurementForRow = function resetMeasurementForRow(rowIndex) {
    this._cellSizeCache.clearRowHeight(rowIndex);
  };

  CellMeasurer.prototype.resetMeasurements = function resetMeasurements() {
    this._cellSizeCache.clearAllColumnWidths();
    this._cellSizeCache.clearAllRowHeights();
  };

  CellMeasurer.prototype.componentDidMount = function componentDidMount() {
    this._renderAndMount();
  };

  CellMeasurer.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
  ...
  CellMeasurer.prototype.componentWillUnmount = function componentWillUnmount() {
    this._unmountContainer();
  };

  CellMeasurer.prototype.render = function render() {
  ...
  CellMeasurer.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    return (0, _reactAddonsShallowCompare2.default)(this, nextProps, nextState);
  };

  CellMeasurer.prototype._getContainerNode = function _getContainerNode(props) {
  ...
  CellMeasurer.prototype._measureCell = function _measureCell(_ref3) {
  ...
  CellMeasurer.prototype._renderAndMount = function _renderAndMount() {
    if (!this._div) {
  ...
  CellMeasurer.prototype._unmountContainer = function _unmountContainer() {
    if (this._div) {
  ...
  CellMeasurer.prototype._updateDivDimensions = function _updateDivDimensions(props) {
