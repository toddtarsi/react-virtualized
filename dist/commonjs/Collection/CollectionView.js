...
var CollectionView = function (_Component) {
  ...
  CollectionView.prototype.recomputeCellSizesAndPositions = function recomputeCellSizesAndPositions() {
    this.setState({
  ...
  CollectionView.prototype.componentDidMount = function componentDidMount() {
  ...
  CollectionView.prototype.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {
  ...
  CollectionView.prototype.componentWillMount = function componentWillMount() {
  ...
  CollectionView.prototype.componentWillUnmount = function componentWillUnmount() {
  ...
  CollectionView.prototype.componentWillUpdate = function componentWillUpdate(nextProps, nextState) {
  ...
  CollectionView.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
  ...
  CollectionView.prototype._enablePointerEventsAfterDelay = function _enablePointerEventsAfterDelay() {
    var _this2 = this;
  ...
  CollectionView.prototype._invokeOnSectionRenderedHelper = function _invokeOnSectionRenderedHelper() {
  ...
  CollectionView.prototype._invokeOnScrollMemoizer = function _invokeOnScrollMemoizer(_ref) {
    var _this3 = this;
  ...
  CollectionView.prototype._setScrollingContainerRef = function _setScrollingContainerRef(ref) {
    this._scrollingContainer = ref;
  };

  CollectionView.prototype._setScrollPosition = function _setScrollPosition(_ref3) {
  ...
  CollectionView.prototype._updateScrollPositionForScrollToCell = function _updateScrollPositionForScrollToCell() {
  ...
  CollectionView.prototype._onScroll = function _onScroll(event) {
